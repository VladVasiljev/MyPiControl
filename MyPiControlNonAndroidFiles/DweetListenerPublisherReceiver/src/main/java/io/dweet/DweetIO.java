...
import static io.dweet.DweetIO.getAPIEndPointURL;
...
public class DweetIO {
    ...
    /**
     * Indicate whether to use SSL encryption or not. Disable for devices that
     * do not support SSL.
     */
     ...
     * @param recipients A comma separated list of Email addresses to send the
     * alert to.
     * @param condition A condition that returns a string or a true value if a
     * condition is met.
